...
$rutaServidor = realpath(__DIR__ . "/../assets/pdf/IRPF");
$directorio = $base_url . "/assets/pdf/IRPF"; // URL pública

// Verificar si la carpeta existe
if (!is_dir($rutaServidor)) {
    echo "<p>Error: El directorio de retenciones no existe. Verifique la configuración.</p>";
    exit();
}
...
if (!empty($archivos)) {
    ...
    echo "<h3 class='titulo-vaca'>RETENCIONES</h3>";
    ...
    echo "<p>No se encontraron documentos en el directorio de retenciones.</p>";
}
